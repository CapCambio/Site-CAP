...
const CONTACT_MESSAGE = encodeURIComponent("Vim do site e gostaria de informações");
...
const waLink = (phone: string) => `https://api.whatsapp.com/send?phone=${phone}&text=${CONTACT_MESSAGE}`;
...
export default function WhatsAppFloat() {
  ...
  useEffect(() => {
    const onOpenEvent = (event: Event) => {
      const detail = (event as CustomEvent<{ hideCaxias?: boolean }>).detail;
