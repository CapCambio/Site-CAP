...
const archivedFaqs = [
  ...
  ["Preciso reservar a moeda antes de ir à loja?", "Não é obrigatório, mas recomendamos a reserva pelo WhatsApp para garantir a disponibilidade da moeda e agilizar o seu atendimento. Você pode nos pedir para apenas separar o valor e deixar reservado para pagar na hora da retirada ou antecipar o pagamento via Pix."],
