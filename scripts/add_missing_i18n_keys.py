...
# Chaves faltantes para adicionar
missing_keys = {
    "header": {
...
def add_keys_to_file(filepath, keys_to_add):
...
if __name__ == "__main__":
    add_keys_to_file('client/src/locales/es.json', missing_keys)
    add_keys_to_file('client/src/locales/fr.json', missing_keys)
    print("Done!")
