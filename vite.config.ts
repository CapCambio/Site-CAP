...
export default defineConfig({
  plugins: [
    react(),
    // Configuração do PWA e Service Worker - DESATIVADO TEMPORARIAMENTE PARA DEBUG
    // VitePWA({
  ...
  build: {
    ...
    terserOptions: {
      compress: {
        // drop_console: true,  // DESATIVADO PARA DEBUG
        // drop_debugger: true,  // DESATIVADO PARA DEBUG
      },
    },
  },
  server: {
